            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                    ...
                    <div className="glass-card p-4 text-sm text-muted-foreground">
                        <p className="mb-2">
                            <strong>Note:</strong> Authentication is required to publish articles. This demo uses a placeholder user ID.
                        </p>
                        <p>
                            You can use Markdown formatting in the editor. Code blocks, lists, headings, and more are supported.
                        </p>
                    </div>
                </div>
            </div>
